<?php include ('header.php'); ?>
    ...
    <div id="myCarousel" class="carousel slide cat" data-ride="carousel">
...
will be distracted by content</p>
  ...
  <div class="container-fluid marketing cat">
...
ลดมลพิษและเน้นเรื่องการประหยัดพลังงานตลอดไป</p>
  ...
  <div class="container-fluid marketing f2 cat">
    <div class="container marketing">
      <div id="Benefits" class="row featurette">
        ...
        <div class="col-md-5">
          <ul class="antinol-ul">
            <li><img src="./img/liststyle_cat.png" width="12">VetzPetz Antinol คืออะไร</li>
            <li><img src="./img/liststyle_cat.png" width="12">ประโยชน์ต่อสุขภาพ</li>
            <li><img src="./img/liststyle_cat.png" width="12">ทำไมจึงต้องเลือกใช้ VetzPetz</li>
            <li><img src="./img/liststyle_cat.png" width="12">ต้องใช้เวลานานเท่าไหร่จึงจะเริ่ม<br>ความเปลี่ยนแปลง</li>
            <li><img src="./img/liststyle_cat.png" width="12">อะไรเป็นสิ่งที่ทำให้ Vetz Petz<br>
มีความพิเศษเหนือกว่าผลิตภัณฑ์<br>
อื่นๆ
</li>
            <li><img src="./img/liststyle_cat.png" width="12">สารอาหารจากอาหารสุนัข<br>
...
ต่อสุนัขอีกหรือ
    ...
    <div class="container marketing cat">
    <!-- Three columns of text below the carousel -->
      <div id="exp" class="row experience">
        ...
        <div class="col-lg-4">
          <img class="plus-ico" src="./img/plus-ico-cat.png">
...
อาการเส้นพลิก ทำให้เดินแล้วเจ็บ....<font style="color:red">More</font></p>
        ...
        <div class="col-lg-12 more-button">
          <a class="more-button" href="#"><img  src="./img/more-button-cat.png" width="150"></a>
        </div>
      </div><!-- /.row -->
